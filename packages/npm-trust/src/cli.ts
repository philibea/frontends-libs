...
import { exec, findWorkspaceRoot, hasExistingTrust, isPackagePublished, listPublicWorkspacePackages } from './utils.ts'
...
function parseArgs_(): Options | null {
  const { values } = parseArgs({
    ...
    options: {
      ...
      repo: { type: 'string', short: 'r', default: 'philibea/frontends-libs' },
